...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        Radio interno        & $R_{\text{int}}$ & \qty{4.980 \pm 0.005}{\centi\meter} \\
...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \textbf{Magnitud} & \textbf{Símbolo} & \textbf{Valor} \\
        \midrule
        Semiancho del tubo        & $a$ & \qty{2.730 \pm 0.005}{\centi\meter} \\
        Semiancho mínimo del hilo & $b$ & \qty{2.550 \pm 0.005}{\centi\meter} \\
        Semialtura de la película & $h$ & \qty{2.780 \pm 0.005}{\centi\meter} \\
        Masa del tubo inferior    & $m$ & \qty{1.2 \pm 0.1}{\gram}      \\
        \bottomrule
    \end{tabular}
\end{table}