...
del agua mediante dos métodos independientes basados en equilibrio
...
brazo mayor, y $\gamma$ se calculó a partir del equilibrio de torques
...
produjo $\gamma_2 = (12{,}21 \pm 1{,}10)\;\si{\milli\newton\per\meter}$,
con un error relativo de \qty{83,2}{\percent}. La marcada diferencia
entre ambos resultados es consistente con la reducción de tensión
...
ausencia de control de temperatura durante el experimento. El segundo
