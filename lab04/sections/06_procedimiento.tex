...
\begin{enumerate}
    ...
    metálico, registrando $R_{\text{ext}} = \qty{5.04 \pm 0.003}{cm}$ y
    $R_{\text{int}} = \qty{4.98 \pm 0.003}{cm}$.
    ...
    \item Se repitieron los pasos 2 a 5 cinco veces más, variando la
    combinación de jinetillos en cada repetición, hasta completar 5
