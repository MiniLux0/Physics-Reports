...
\begin{itemize}
    ...
    determinar la longitud natural y la longitud deformada del resorte y la liga
    bajo cada carga aplicada.
...
\begin{itemize}
    \item \textbf{Descripción y función:} Instrumento utilizado para medir las
    dimensiones de la sección transversal del resorte y de la liga, tanto en estado
    natural como bajo deformación.
    \item \textbf{Especificaciones:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Especificaciones:}
    \begin{itemize}
        \item $m_1$: nominal \qty{250}{g}
        \item $m_2$: nominal \qty{250}{g}
        \item $m_3$: nominal \qty{500}{g}
        \item $m_4$: nominal \qty{1000}{g}
    \end{itemize}
